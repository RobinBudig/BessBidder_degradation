...
def simulate_period(
    ...
    while current_day < end_day:
        ...
        while execution_time_end < trading_end:
            ...
            t0 = time.perf_counter() #time before DB call
            ...
            db_time_total += time.perf_counter() - t0 # time after DB call
            ...
            t_csv0 = time.perf_counter() # time before vwap csv write
            ...
            vwap_csv_time_total += time.perf_counter() - t_csv0 # time after vwap csv write
            ...
            if vwap["price"].isnull().all():
                ...
                try:
                    t_s0 = time.perf_counter() # time before solver
                    ...
                    solver_time_total += time.perf_counter() - t_s0 # time after solver
